...
public class Utils {
    ...
    public static final String BASE_URL = "https://fishki.net/";

    public static final String CORRECT_LOGIN = "I_want_another_variant";
    public static final String CORRECT_PASSWORD = "wrong_password_12345";
    public static final String WRONG_PASSWORD = "correct_password_54321";
    public static final String SEARCH_INPUT = "fishka";

    public static List<WebDriver> getDrivers() {
        List<WebDriver> drivers = new ArrayList<>();
        try {
            List<String> properties = Files.readAllLines(Paths.get("src/fishki.properties"));
    ...
    public static void enterSite(WebDriver driver) {
        driver.get(Utils.BASE_URL);
    }

    public static void login(WebDriver driver) {
        WebElement loginButton = getElementBySelector(driver, By.xpath("/html/body/header/div/div/ul/li/a"));
        loginButton.click();
        WebElement loginInput = getElementBySelector(driver, By.xpath("/html/body/section/div/div/div[2]/div[1]/form/input[4]"));
        WebElement loginPassword = getElementBySelector(driver, By.xpath("/html/body/section/div/div/div[2]/div[1]/form/input[5]"));
        WebElement authButton = getElementBySelector(driver, By.xpath("/html/body/section/div/div/div[2]/div[1]/form/button"));
        loginInput.clear();
        loginPassword.clear();
